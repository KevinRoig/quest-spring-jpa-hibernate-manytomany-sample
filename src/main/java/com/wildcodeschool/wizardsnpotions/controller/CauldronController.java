...
public class CauldronController {
    ...
    public String removeIngredientFromPotion(@RequestParam(required = false) Long idPotion,
                                             @RequestParam(required = false) Long idPotionIngredient) {

        if (idPotionIngredient != null) {
            Optional<PotionIngredient> optionalPotionIngredient = potionIngredientRepository.findById(idPotionIngredient);
            if (optionalPotionIngredient.isPresent()) {
                potionIngredientRepository.delete(optionalPotionIngredient.get());
            }
        }
